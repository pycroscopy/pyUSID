# -*- coding: utf-8 -*-
#
# pyUSID documentation build configuration file, created by
...
# this is needed for some reason... {Copied from scikit-learns conf.py}
...
project = u'pyUSID'
copyright = u'2016, Suhas Somnath, Chris Smith, Stephen Jesse'
author = u'Suhas Somnath, Chris Smith, Stephen Jesse'
...
latex_documents = [
    (master_doc, 'pyUSID.tex', u'pyUSID Documentation',
     u'Suhas Somnath, Chris Smith', 'manual'),
]
